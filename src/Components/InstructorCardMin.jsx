...
const InstructorCardMin = ( { instructorData } ) => {
    ...
    return (
        <Card className="w-full lg:max-w-[20rem] shadow-lg drop-shadow-sm hover:shadow-primary hover:shadow hover:border-secondary hover:border dark:hover:border-white dark:hover:shadow-none duration-300 dark:duration-0 rounded-lg overflow-hidden dark:bg-opacity-40 dark:text-white">
            {
                photoURL ?
                    <img
                        src={ photoURL }
